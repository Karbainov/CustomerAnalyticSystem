...
namespace TempProject
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //}
            CustumerInfoService custumerInfoService = new CustumerInfoService();
            List<TagMarksDTO> tempList = new List<TagMarksDTO>();
            tempList = custumerInfoService.GetAllMarksOfTagByCustomerId(1);
